  ...
  return (
    ...
    >
      <TouchableOpacity
        ...
        onPress={onClose}
      >
        <View className="bg-white dark:bg-neutral-900 rounded-t-3xl p-6 pb-8 border-t-2 border-gray-300 dark:border-neutral-800">
          <View className="w-12 h-1 bg-gray-300 dark:bg-gray-600 rounded-full self-center mb-6" />

          <ThemedText className="text-lg font-semibold text-gray-800 dark:text-white mb-4">
            Chore Options
          </ThemedText>
          ...
          {showRequestSwap && onRequestSwap && (
            <TouchableOpacity
              ...
              className="flex-row items-center py-4 px-2 rounded-xl mb-2 active:bg-gray-200 dark:active:bg-neutral-800"
            >
              ...
              <View className="flex-1">
                <ThemedText className="text-base font-medium text-gray-800 dark:text-white">
                  Request Swap
                </ThemedText>
