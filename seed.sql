-- 1. USERS
INSERT INTO
    "user" (fb_uid, name, email, avatar_url)
VALUES
    (
        'fb_001',
        'Alice Johnson',
        'alice@example.com',
        'https://pics.com/alice.png'
    ),
    (
        'fb_002',
        'Bob Smith',
        'bob@example.com',
        'https://pics.com/bob.png'
    ),
    (
        'fb_003',
        'Carlos Vega',
        'carlos@example.com',
        'https://pics.com/carlos.png'
    ),
    (
        'fb_004',
        'Diana Wu',
        'diana@example.com',
        'https://pics.com/diana.png'
    ),
    (
        'fb_005',
        'Ethan Miles',
        'ethan@example.com',
        'https://pics.com/ethan.png'
    );

-- 2. ROOMS
INSERT INTO
    "room" (room_code, created_by, name)
VALUES
...
-- 3. ROOM MEMBERSHIPS
INSERT INTO
    "room_membership" (user_id, room_id, role)
VALUES
    (1, 1, 'admin'),
    (2, 1, 'member'),
    (3, 2, 'admin'),
...
VALUES
    (
        ...
        2,
        '08:00',
        'Take bins out every Tuesday morning.',
        '2025-07-01',
        1
    ),
    (
...
-- 6. CHORE COMPLETIONS
INSERT INTO
    "chore_completion" (chore_id, membership_id, status, points_earned)
VALUES
    (1, 1, 'verified', 5),
    (2, 2, 'pending', 0),
    (3, 3, 'verified', 10),
...
INSERT INTO
    "chore_assignment_history" (chore_id, membership_id, status)
VALUES
    (1, 1, 'completed'),
    (2, 2, 'assigned'),
    (3, 3, 'completed'),
...
-- 11. EXPENSE SPLITS
INSERT INTO
    "expense_split" (expense_id, membership_id, amount_owed, is_paid)
VALUES
    (1, 1, 20.00, TRUE),
    (1, 2, 20.00, FALSE),
    (2, 1, 10.00, TRUE),
